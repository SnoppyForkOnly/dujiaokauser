...
class PaypalPayController extends PayController
{
    ...
    private function convertCurrency($amount, $from = 'CNY', $to = 'USD') {
        // 设置固定汇率，例如1 CNY = 0.15 USD
        $fixedRate = 0.15;
    
        // 计算并返回转换后的金额
        return round($amount * $fixedRate, 2);
    }
    ...
    public function gateway(string $payway, string $orderSN)
    {
        try {
            ...
            // 得到汇率
       $total = $this->convertCurrency($this->order->actual_price, 'CNY', 'USD');
