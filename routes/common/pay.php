...
Route::group(['prefix' => 'pay', 'namespace' => 'Pay', 'middleware' => ['dujiaoka.pay_gate_way']], function () {
    ...
    Route::get('alpha/{payway}/{orderSN}','AlphaController@gateway');
    Route::post('alpha/notify_url','AlphaController@notifyUrl');
    Route::get('wallet/{orderSN}', 'WalletController@walletPay');
